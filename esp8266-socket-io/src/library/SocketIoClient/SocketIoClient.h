...
#include <map>
#include <vector>
#include "../WebSocketsClient/WebSocketsClient.h"
...
private:
    ...
    void initialize();
public:
    void beginSSL(const char* host, const int port = DEFAULT_PORT, const char* url = DEFAULT_URL, const uint8_t* fingerprint = DEFAULT_FINGERPRINT);
